...
public class HomeIslandScene extends GameScene {
    ...
    public void setup() {
        ...
        EnterHomeLabel homeLabel = new EnterHomeLabel("Press 'E' to enter", 6* Config.tileSize, 3*Config.tileSize, Config.tileSize* 0.75, Config.tileSize* 0.75);
        homeLabel.removeFromUI();
        homeLabel.getComponent(LabelComponent.class).getUIElement().setTextAlignment(TextAlignment.CENTER);

        EnterInnLabel innLabel = new EnterInnLabel("Press 'E' to enter", 3* Config.tileSize, 3*Config.tileSize, Config.tileSize* 0.75, Config.tileSize* 0.75);
