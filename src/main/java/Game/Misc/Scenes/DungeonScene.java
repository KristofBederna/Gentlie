...
public class DungeonScene extends GameScene {
    ...
    private void declareEntities() {
        ...
        new MeleeAttackLabel(String.valueOf(PlayerStats.meleeCooldown), 100, 400, 100, 100);
        new RangedAttackLabel(String.valueOf(PlayerStats.rangedCooldown), 100, 500, 100, 100);
