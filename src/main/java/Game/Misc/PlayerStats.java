...
public class PlayerStats {
    ...
    public static double meleeDamage = 42;
    ...
    public static long meleeCooldown = 1750;
    public static long rangedCooldown = 2500;

    public static final double BASELINE_Health = 100;
    public static final double BASELINE_MeleeDamage = 42;
    ...
    public static final int BASELINE_Gold = 250;
    ...
    public static final long BASELINE_MeleeCooldown = 1750;
    public static final long BASELINE_RangedCooldown = 2500;
