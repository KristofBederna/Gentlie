...
public class BigSnowBallEntity extends Entity {
    public BigSnowBallEntity(double x, double y, double width, double height, Vector initialVelocity) {
        ...
        addComponent(new VelocityComponent(initialVelocity, 9));
        addComponent(new DragComponent(0.75));
        addComponent(new MassComponent(1.5));
