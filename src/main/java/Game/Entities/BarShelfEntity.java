...
public class BarShelfEntity extends Entity {
    public BarShelfEntity(double x, double y, double width, double height) {
        ...
        this.addComponent(new ImageComponent("/assets/images/Inn_Bar_Shelf.png", width, height));
