...
public class Test2Scene extends GameScene {
    ...
    public void setup() {
        new ResourceStartUp();
        WorldEntity.getInstance(30, 15, "/assets/maps/testMap.txt", "/assets/tileSets/testTiles.txt");
    ...
    private void interactionSetup(Entity entity2) {
        ...
        dummyInteractiveComponent.mapInput(KeyCode.ENTER, 100, () -> SystemHub.getInstance().getSystem(SceneManagementSystem.class).requestSceneChange(new Test3Scene(new BorderPane(), 1920, 1080)));
    }
